...
class clsListAvailableRoomsScreen : clsScreen
{
...
public:
	...
	static void ShowListAvailableRoomsScreen()
	{
		vector<clsRoom> vRooms = clsRoom::GetAvailableRoomsList();

		string Title = "\t\t Available Rooms List Screen";
		...
		{
			cout << left << setw(19) << " " << "|";
			cout << left << setw(81) << "Sorry There Are No Available Rooms in The System!" << "|\n";
		}
